                            ...
                            if(checkTripExpiration(trip, tripSnapshot.key.toString()) == "Valid"){
                                if(fromLocation.text.isEmpty()  && toLocation.text.isEmpty() ) { //&& userType.isNullOrEmpty()
                                    if (trip.lookingFor.equals(userIs)) {
                                        ...
                                        Toast.makeText(this@MainActivity, validTripArrayList.size.toString(), Toast.LENGTH_SHORT).show()
                                    }
                                } else
                                    if(trip.lookingFor.equals(userIs)){
...
//    private fun checkTripIDArrayListCount() {
//        Toast.makeText(this, this.validTripIdArrayList.size.toString(), Toast.LENGTH_SHORT).show()
//    }
